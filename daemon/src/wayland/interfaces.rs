        ...
        fn error(&mut self, object_id: ObjectId, code: u32, message: &str) {
            let interface = match object_id {
                ...
                other => match super::super::globals::object_type_get(other) {
                    super::super::WlDynObj::Output => "wl_output",
                    super::super::WlDynObj::Surface => "wl_surface",
                    super::super::WlDynObj::Region => "wl_region",
                    super::super::WlDynObj::LayerSurface => "zwlr_layer_surface_v1",
                    super::super::WlDynObj::Buffer => "wl_buffer",
                    super::super::WlDynObj::ShmPool => "wl_shm_pool",
